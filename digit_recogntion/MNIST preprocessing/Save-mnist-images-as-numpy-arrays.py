...
path = 'MNIST preprocessing/mnist-dataset/'
...
np.save('MNIST preprocessing/train_images.npy', train_images)
np.save('MNIST preprocessing/train_labels.npy', train_labels)
np.save('MNIST preprocessing/test_images.npy', test_images)
np.save('MNIST preprocessing/test_labels.npy', test_labels)
