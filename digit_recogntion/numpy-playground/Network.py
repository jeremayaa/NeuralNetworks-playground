...
class Network(object):
    ...
    def __init__(self, sizes):
        """
        This initialize weights and biases for network. Sizes is a list, contains
    ...
    def SGD(self, training_data, epochs, batch_size, eta,
        ...
        into random packages (with "batch_size" number of elements), then
        it trains network on every batch.
        Process is repeted for every epoch.
